package comsyz.es.java.api;


import com.alibaba.fastjson.JSONObject;
import comsyz.es.java.api.bean.EsModel;
import comsyz.es.java.api.bean.EsPage;
import comsyz.es.java.api.utils.ElasticsearchUtil;
...
public class EsController {
    ...
    public String insertJson(String id) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("id", id);
        jsonObject.put("age", 25);
        jsonObject.put("name", "j-" + new Random(100).nextInt());
        jsonObject.put("date", new Date());
        String id1 = ElasticsearchUtil.addData(jsonObject, indexName, esType, jsonObject.getString("id"));
        return id1;
    }
